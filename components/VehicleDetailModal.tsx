        ...
        <div className="fixed inset-0 bg-black bg-opacity-75 flex justify-center items-center z-50 p-4 transition-opacity" onClick={onClose}>
            ...
            >
                ...
                <div className="flex justify-between items-center p-8 border-b border-gray-200 dark:border-gray-700">
                    <h2 className="text-5xl font-bold text-gray-900 dark:text-white">{vehicle.make} {vehicle.model}</h2>
                ...
                <div className="flex-1 overflow-y-auto">
                    <div className="grid grid-cols-1 lg:grid-cols-5 lg:gap-8">
                        ...
                        <div className="lg:col-span-3 flex flex-col">
                            <div className="aspect-[4/3] bg-gray-200 dark:bg-black m-8 rounded-lg overflow-hidden">
                        ...
                        <div className="lg:col-span-2 p-8 bg-white dark:bg-gray-900/50 flex flex-col">
